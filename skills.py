...
CLASS_SKILLS = {
    "sword": {
        ...
        "skills": (
            ...
            Skill("Aegis Breaker", 4, 24, "A shielded strike that reduces the next incoming hit.", 45, 60, guard=10),
            Skill("Blade Tempest", 7, 36, "Four rapid sword arcs tear through the enemy.", 18, 25, hits=4),
            Skill("Radiant Oath", 10, 50, "A legendary finishing cut that also restores 25 HP.", 100, 135, heal=25),
        ),
    },
    "bow": {
        "name": "Ranger",
        ...
        "skills": (
            ...
            Skill("Arrow Barrage", 4, 28, "Rain five arrows onto the enemy in quick succession.", 12, 18, hits=5),
            Skill("Windstep Volley", 7, 30, "Fire twice and evade the enemy's next attack.", 22, 30, hits=2, evade=True),
            Skill("Starfall Rain", 10, 50, "A celestial storm of seven devastating arrows.", 17, 24, hits=7),
        ),
    },
    "axe": {
        "name": "Berserker",
        ...
        "skills": (
            ...
            Skill("War Cry", 4, 22, "Strike with fury and empower the next normal attack.", 35, 48, attack_bonus=20),
            Skill("Earthshaker", 7, 36, "Crack the ground and weaken the enemy's next attack.", 78, 105, weaken=12),
            Skill("Ragnarok Splitter", 10, 55, "Commit everything to one cataclysmic axe strike.", 135, 180),
        ),
    },
}
